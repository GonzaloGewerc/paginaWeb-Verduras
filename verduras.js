...
/* Podés borrar esto si no lo usás más; lo dejo por compatibilidad. */
...
/* ============================
   ...
   Guardá tus archivos en /img (al lado de index.html)
   y ajustá los nombres si querés. JPG/PNG/WebP sirven.
   Recomendado: 1200x800 aprox., <300 KB.
   ============================ */
const PRODUCTS = [
  { id:"clasico",  nombre:"Bolsón Clásico",      precio:7990,  badge:"Ideal para 1–2 personas",
    ...
    img:"zanahoria.JPG" },   // UPDATED: ruta a tu archivo local
...
/* ========== Lazy load para background de las cards (ya implementado) ========== */
let bgObserver = null;
...
const renderPage = () => {
  ...
  for (let i = 0; i < itemsPerView; i++) {
    ...
    article.dataset.bg = p.img; // UPDATED: usa tu archivo local como background
